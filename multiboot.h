...
#define DEF_MBH_MODE_TYPE       0x00000000        /* graphic mode               */
#define DEF_MBH_WIDTH           0x00000320        /* width  = 800               */
#define DEF_MBH_HEIGHT          0x00000258        /* height = 600               */
#define DEF_MBH_DEPTH           0x00000020        /* bpp = 32                   */
